...
STOP_LAP = 3			#time to stop the vehicles
time_base = 0										#start time of the system

LAP_LATITUDE = 120.0		#OVAL:	120.0	#CURVE: 160.0
...
TARGET_SPEED_2 = 12.00 		#target speed (approx 50KM/h)
TARGET_SPEED_3 = 16.00 		#target speed (approx 50KM/h)
VEL_CRUZEIRO_1 = 50.0			#KM/H	50
VEL_FRENAGEM_1 = 50.0			#KM/H	30

VEL_CRUZEIRO_2 = 43.0			#KM/H	40
VEL_FRENAGEM_2 = 43.0			#KM/H	40

VEL_CRUZEIRO_3 = 60.0			#KM/H	60
VEL_FRENAGEM_3 = 60.0			#KM/H	60
...
def calc_throttle_brake(s_sp, s_real):
	...
	#if(abs(accel_control) < EDGE_LOW_SPEED and s_sp == MIN_VEL or current_time_TV < 30):		#necessario para zerar a velocidade
