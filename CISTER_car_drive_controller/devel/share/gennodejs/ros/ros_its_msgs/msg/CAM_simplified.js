...
class CAM_simplified {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('yawRate_Value')) {
        this.yawRate_Value = initObj.yawRate_Value
      }
      else {
        this.yawRate_Value = 0.0;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [yawRate_Value]
    bufferOffset = _serializer.float32(obj.yawRate_Value, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [yawRate_Value]
    data.yawRate_Value = _deserializer.float32(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return 'd8b43deb6d5065c30dd949c81c1cdd89';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.yawRate_Value !== undefined) {
      resolved.yawRate_Value = msg.yawRate_Value;
    }
    else {
      resolved.yawRate_Value = 0.0
    }
