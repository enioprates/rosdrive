...
(cl:defmethod yaw_rate-val ((m <OMNET_CAM>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_its_msgs-msg:yaw_rate-val is deprecated.  Use ros_its_msgs-msg:yaw_rate instead.")
  (yaw_rate m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<OMNET_CAM>)))
  ...
  "21ec4be3131518917e90b050170a58f5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'OMNET_CAM)))
  "Returns md5sum for a message object of type 'OMNET_CAM"
  "21ec4be3131518917e90b050170a58f5")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<OMNET_CAM>)))
  ...
  (cl:format cl:nil "string car_name~%~%float32 latitude~%float64 longitude~%float32 altitude~%~%float32 heading~%float32 speed~%~%float32 acceleration~%~%float32 yaw_rate~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'OMNET_CAM)))
  "Returns full string definition for message of type 'OMNET_CAM"
  (cl:format cl:nil "string car_name~%~%float32 latitude~%float64 longitude~%float32 altitude~%~%float32 heading~%float32 speed~%~%float32 acceleration~%~%float32 yaw_rate~%~%~%"))
